...
div(
    ...
    fluidRow(
      ...
      box(
       ...
       collapsible = FALSE,
       a(icon("download"), "Descargar plantilla RepGrid", href = "", id = "download_link_repgrid", download = "RepGrid_Template.xlsx", class = "link"),
       br(),
       a(icon("download"), "Descargar plantilla WimpGrid", href = "", id = "download_link_wimpgrid", download = "plantilla_wimpgrid.xlsx", class = "link"),
       br(),
