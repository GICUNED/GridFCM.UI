...
wimpgrid_analysis_ui <- fluidPage( class="header-tab wg-diff",
  ...
  tabPanel(i18n$t("Datos"), id = "tab_data_w", icon = icon("table"),
          fluidRow( class = ("flex-container-xl"),
                      ...
                      p(i18n$t("Esta página te permite visualizar y manipular los datos importados de Wimpgrid y acceder a diferentes tipos de análisis."),  class = "desccustom mb-4"),
                  ),
  ...
  shinyjs::hidden(div(id="wg-data-content",
  ...
  tabPanel(i18n$t("Visualización"), id = "tab_visualizacion", icon = icon("square-poll-vertical"),
      ...
      shinyjs::hidden(div(id="wg-vis-content",
        fluidRow(class = "input-graphic-container",
          column(3, class = "input-field-container rounded-lg",
            div(class = "flex-container-sm align-left-title",
                  icon("bars-progress"),
                  h4(i18n$t("Controles"), class = "pagetitle2custom mt-2"),
            ),
            ...
            conditionalPanel(class = ("flex-container-resp"),   condition = "input.graph_selector_visualizacion == 'selfdigraph' || input.graph_selector_visualizacion == 'autodigrafo'",
                              ...
                              sliderInput("selfdigraph_vertex_size", i18n$t("Tamaño de los vértices:"), 1, 10, 1),
        ...
        conditionalPanel(condition = "input.graph_selector_visualizacion == 'wimpindices' || input.graph_selector_visualizacion == 'índices de Wimp' ",
                          ...
                          htmlOutput("dens")
                            ...
                            fluidRow(class = "subheader-tab flex-container-sm mt-4  mb-4",
                              ...
                              h4(i18n$t("Centralidad"), class = "pagetitle2custom mt-2"),
                            ...
                            fluidRow(class = "subheader-tab flex-container-sm mt-4 mb-4",
                              icon("arrows-to-circle"),
                              h4(i18n$t("Inconsistencias"), class = "pagetitle2custom mt-2"),
  ...
  tabPanel(i18n$t("Laboratorio"), id = "tab_laboratorio", icon = icon("flask-vial"),
      ...
      shinyjs::hidden(div(id="wg-lab-content",
        fluidRow(class = "input-graphic-container",
            ...
            column(9, class = "graphic-container bg-white rounded-lg gap-2",
                fluidRow(class = "flex-container-resp",
                    ...
                    conditionalPanel(class = "graphic-subcontainer",  condition = "input.graph_selector_laboratorio == 'pcsdindices'",
                      div(class = "flex-container-sm align-left-title",
                        icon("table"),
                        h4(i18n$t("Resultados"), class = "pagetitle2custom mt-2"),
                      ),
