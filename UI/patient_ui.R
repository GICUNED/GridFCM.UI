patient_ui <- fluidPage(class="patient-diff",
  ...
  fluidRow( class = ("flex-container-xl mt-2 mb-4"),
        ...
        div(class="patient-form-container",
            div(class = "flex-container-resp-col",
              ...
              div(class="d-flex w-100",
                ...
                column(6, class = "w-50 p-0", selectInput("genero", i18n$t("Género:"), c("Hombre", "Mujer", "Sin definir"), selectize = FALSE)),
              ),
    ...
    div(class="patient-form-container",
        div(class="flex-container-resp-col",
          ...
          div(class="d-flex w-100",
            ...
            column(6, class = "p-0", selectInput("generoEdit", i18n$t("Género:"), c("Hombre", "Mujer", "Sin definir"), selectize = FALSE)),
          ),
