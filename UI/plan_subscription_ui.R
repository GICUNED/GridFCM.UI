plan_subscription_ui <- fluidPage(class="custom-margins-md",
    ...
    fluidRow(id="panel-compra",
        ...
        p( strong(i18n$t("Atención:")), i18n$t("Si se vuelve a comprar otra suscripción cuando sigue activa la actual, no se añade más tiempo a la suscripción. Por ello, es mejor configurar una renovación automática o esperar a que se termine la fecha de suscripción, para ampliar la actual."))
    ),
    ...
    column(12, id="panel-gestion-licencias", class="mt-4 mb-2",
        ...
        column(12, class = "licencias-table p-3 bg-white rounded-lg mt-2",
        ...
        column(12, id = "gestion-licencias", class = "gestion-licencias p-3 mt-4 bg-white rounded-lg mix-diff simulation-tab",
                ...
                div(class="participant-form-container",
                    div(class = "flex-container-resp-col",
                        ...
                        div(id="segundo_paso", class = "flex-container-resp-col hidden-div",
                            actionButton("confirmAddParticipant", i18n$t("Confirmar"), status = 'success', disabled=TRUE, icon = icon("check")),
                            actionButton("cancelAddParticipant", i18n$t("Cancelar"), disabled=TRUE)
